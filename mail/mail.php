...
$sendingAccountUsername     = 'victoriamaciasphotography@gmail.com';
$sendingAccountPassword     = 'Straw6erry';

// Recipient (To:) Details  - Change this to the email details of who will receive all the emails from the website.
$recipientEmail             = 'victoriamacias@ymail.com'; // REQUIRED value.
$recipientName              = 'Victoria Macias';             // REQUIRED value.
